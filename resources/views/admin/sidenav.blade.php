        ...
        <div class="profile-desc">
          <div class="profile-pic">
            ...
            <div class="profile-name">
              <h5 class="mb-0 font-weight-normal">Elias Tush</h5>
              <span>ADMIN</span>
            </div>
          </div>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{url('/teachers')}}"> New Teacher </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{url('/all-teachers')}}"> All Teachers </a></li>
          </ul>
        </div>
      </li